# Q:
帮我分析@custom-leaflet-draw 这个目录下的内容（不用考虑topo、simpleEdit、interaction、image-extraction目录的内容），我准备重构下这部分内容。重构原因： 我目前只让矩形和多边形支持了撤销、编辑、等等一系列的功能，但是点线面应该都有编辑的部分功能，
