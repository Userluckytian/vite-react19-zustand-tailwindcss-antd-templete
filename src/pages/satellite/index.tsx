...
const Satellite = () => {
    ...
    const radarItems = [
        ...
        },
        {
            ...
            name: "高光谱观测卫星(GF-5B)",
            load: ["可见短波红外高光谱相机", "全谱段光谱成像仪", "多角度偏振成像仪", "紫外高光谱大气成分探测仪"],
            resolution: [
                "30",
                "20/40",
                "优于3.5",
        ...
        },
        {
            ...
            load: ["可见短波红外高光谱相机", "宽幅热红外成像仪", "大气痕量气体差分吸收光谱仪"],
            resolution: [
                "30±0.1",
                "≤100（星下点）",
                "优于 24（垂直于轨道）×13（沿轨方向）",
...

        {
            ...
            load: ["多光谱相机（5波段）", "高光谱相机（215波段）", "红外相机（9波段）"],
            resolution: [
                "16m",
                "48/96",
                "48/96", ,
    ...
    useEffect(() => {
        ...
        const step = (t: number) => {
            ...
            const b = Math.max(10, bbox.height / 2 - 20);
